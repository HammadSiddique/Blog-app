...
post2 = Post.create(author: first_user, title: 'World', text: 'This is my second post', comments_counter: 0, likes_counter: 0)
post3 = Post.create(author: first_user, title: 'Coding', text: 'This is my third post', comments_counter: 0, likes_counter: 0)
post4 = Post.create(author: second_user, title: 'Hello', text: 'This is my first post', comments_counter: 0, likes_counter: 0)
post5 = Post.create(author: second_user, title: 'World', text: 'This is my second post', comments_counter: 0, likes_counter: 0)
